package net.ion.talk.example.inbound;
...
import net.ion.talk.example.Remote;
import net.ion.talk.exception.BadNumberOfArgumentsException;
import net.ion.talk.exception.NoSuchRemoteMethodException;
