...
function init(){
  ...
  <rect x="0" y="5" rx="10" ry="10" width="230" height="${rectHeight}" style="fill:#f4cecf;stroke:black;stroke-width:2;opacity:0.1" id="msg_${node.property(messageId).asString()}"/>
  ...
  <text x ="100" y ="65" fill="navy" font-size="11">
