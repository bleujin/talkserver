...
import net.ion.emotion.util.HeuristicsUtility;
import net.ion.emotion.util.LexicalUtility;
import net.ion.emotion.util.ParsingUtility;
...
public class Empathyscope {
	...
	public static EmotionalState feel(String text) throws IOException {
		...
		for (String sentence : sentences) {
			...
			// (1) more exclamination signs in a sentence => more intensive emotive weights
			...
			for (String splittedWord : splittedWords) {
				...
				if (emoWord != null) {
					// (3) more emoticons with more 'emotive' signs (e.g. :DDDD) => more intensive emotive weights
					...
					for (String word : words) {
						...
						// (4) negation in a sentence => flip valence of the affect words in it
						...
						if (emoWord != null) {
							...
							// (6) previous word is a intensity modifier (e.g. "extremly") => more intensive emotive weights
