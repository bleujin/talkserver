...
public class TestAradonRepresentation extends TestCase implements IServiceLet{
    ...
    public void testResponse() throws Exception {
        ...
        Aradon aradon = AradonTester.create().register("test", "/",  TestAradonRepresentation.class).getAradon();
        ...
        net.ion.radon.aclient.Response ncResponse = NewClient.create().prepareGet("http://localhost:9000/test/").execute().get();
