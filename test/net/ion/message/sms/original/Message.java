...
public class Message
    ...
    단건 문자 메시지 호출 하는 함수
    */
    public String sendMain(String member, String usercode, String username,
                           String callphone1,
                           String callphone2, String callphone3,
                           String callmessage, String rdate,
                           String rtime, String reqphone1, String reqphone2,
                           String reqphone3,
  ...
  /*
    ...
    public String sendURLMain(String member, String usercode, String username,
                              String callphone1,
                              String callphone2, String callphone3,
                              String callmessage, String rdate,
                              String rtime, String reqphone1, String reqphone2,
...
//                        "]	status=[" + status + "]\n");
    ...
    private void sendURLRequest(DataOutputStream dos, String[] urlFieldData) throws
            IOException {
    ...
    private String reciveURLResponse(BufferedInputStream bis) {
        ...
        try {
            ...
            if (iReadCount > 0) {
                ...
                status = new String(byteBuff, 94, 1);
                writeFile("command=[" + urlFieldData[0] + "]	usercode=[" +
                        urlFieldData[4] + "]	username=[" + urlFieldData[5] +
                        "]	callphone1=[" + urlFieldData[9] + "]	callphone2=[" +
                        urlFieldData[10] + "]	callphone3=[" + urlFieldData[11] +
                        "]	callmessage=[" + urlFieldData[12] + "]	callurl=[" +
                        urlFieldData[13] + "]	rdate=[" + urlFieldData[14] +
                        "]	rtime=[" + urlFieldData[15] + "]	reqphone1=[" +
                        urlFieldData[16] + "]	reqphone2=[" + urlFieldData[17] +
