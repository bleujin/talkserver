...
public class Test {
	public static void main(String[] argvs) {
		...
		result = M.sendMain(member, usercode, username, callphone1, callphone2, callphone3, callmessage, rdate, rtime, reqphone1, reqphone2, reqphone3, callname, deptcode, deptname);
