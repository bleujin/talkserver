...
String.prototype.getByteLength = function (){
	...
	for(var z=0; this != '' && z < this.length; z++){
...
String.prototype.isResourceFileNames = function(){ // input file name 
	if(this.length > 0 ){
		return (/^[a-zA-Z0-9_()\-. ]+$/.test(this));
	}
	return true;
...
Date.prototype.addMonth = function(num){
	if(this.getMonth() == 0 && this.getDate() >= 29) { // ibr_13146
		return this.addDay(0, num, -3, 0, 0, 0);
	}
	if(this.getDate() == 31) { 
		return this.addDay(0, num, -1, 0, 0, 0);
	}
