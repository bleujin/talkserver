<svg version="1.1" id="svg_${node.property(messageId).asString()}" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" xml:space="preserve" height="70">
    <g id="bubble_${node.property(messageId).asString()}" opacity="1" height="70">
        <image id="char_${node.property(messageId).asString()}" xlink:href="/image/bimage/toon/char/${charId}/${emotion}.png" x="0" y="20" height="60" width="60"/>
        <rect id="rect_${node.property(messageId).asString()}" width="250" height="55" x="0" rx="10" ry="10" style="fill:#f4cecf;stroke:black;stroke-width:2;opacity:0.1;"/>
